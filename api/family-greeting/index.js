...
module.exports = async function (context, req) {
    ...
    try {
        ...
        const familyMembers = [
            {
                name: 'Тая',
                description: '13 лет, девочка, учится в 7 классе, занимается танцами, акробатикой и гимнастикой, любит рисовать. Ее называют Пикми. Любит бардак и есть в комнате. Сложно дается математика. Обожает шоколад и может есть его без остановки. Не любит загружать и разгружать посудомойку.'
            },
            {
                name: 'Сева',
                description: '11 лет, мальчик, учится в 5 классе, очень любит есть разную еду, особенно KFC. Любит играть в игры, может делать это без остановки. Занимается кикбоксингом и играет на гитаре, правда его всегда приходится заставлять играть на гитаре. Учится плохо, постоянно все забывает. Его надо 5 раз просить вынести мусор. Не любит загружать и разгружать посудомойку.'
            },
            {
                name: 'Зоя',
                description: '9 лет, девочка, учится в 3 классе. Занимается гимнастикой, играет на барабанах. Очень любит рисовать, делать поделки и всякие эксперименты. Не любит загружать и разгружать посудомойку.'
            },
            {
                name: 'Арина (мама)',
                description: '37 лет, мама в семье. Любит учиться, хотя иногда ей дается это тяжело, любит бегать а еще иногда очень долго играть в шарики и ферму, но это временно. Постоянно занимается детьми, готовит, возит их на занятия. Очень много убирается, потому что дети постоянно мусорят.'
            },
            {
                name: 'Женя (папа)',
