...
module.exports = async function (context, req) {
    ...
    try {
        ...
        const familyMembers = [
            {
                name: 'Тая',
                description: '13 лет, девочка, учится в 7 классе, занимается танцами, акробатикой и гимнастикой, любит рисовать. Ее называют Пикми. Любит бардак и есть в комнате. Сложно дается математика. Обожает шоколад и может есть его без остановки. Не любит загружать и разгружать посудомойку. Катается на сноуборде. Любит сериал Stranger Things и ждет его выхода.'
            },
            {
                name: 'Сева',
                description: '11 лет, мальчик, учится в 5 классе. Очень любит есть разную еду, особенно в KFC и других ресторанах. Любит играть в игры, в том числе в «Зельду». На гитаре может играть целый день без остановки. Любит учиться, особенно французский язык. Занимается кикбоксингом и не очень любит акробатику, но всё равно ходит на неё. Иногда забывает вынести мусор и не любит загружать и разгружать посудомойку. Катается на горных лыжах и занимается робототехникой. В целом Сева очень хороший мальчик. Любит сериал Stranger Things и ждёт его выхода.'
            },
            {
                name: 'Зоя',
                description: '9 лет, девочка, учится в 3 классе. Занимается гимнастикой, играет на барабанах. Очень любит рисовать, делать поделки и всякие эксперименты. Не любит загружать и разгружать посудомойку. Катается на горных лыжах. Любит сериал Stranger Things и ждет его выхода.'
            },
            {
                name: 'Арина (мама)',
                description: '37 лет, мама в семье. Любит учиться, хотя иногда ей дается это тяжело, любит бегать, а еще иногда очень долго играть в шарики и ферму, но это временно. Постоянно занимается детьми, готовит, возит их на занятия. Очень много убирается, потому что дети постоянно мусорят. Любит кататься на велосипеде. Катается на горных лыжах. Любит путешествовать. Любит сериал Stranger Things и ждет его выхода.'
            },
            {
                name: 'Женя (папа)',
                description: '37 лет, папа в семье, очень много работает и любит поесть. Занимается бегом и ходит в спортзал. Часто залипает в телефоне и любит валяться. Любит покупать дорогую одежду и гаджеты. Катается на сноуборде и велосипеде. Любит сериал Stranger Things и ждет его выхода.'
            }
        ];
