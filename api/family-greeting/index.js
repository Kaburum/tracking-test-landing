...
module.exports = async function (context, req) {
    ...
    try {
        ...
        const familyMembers = [
            ...
            {
                name: 'Арина (мама)',
                description: '37 лет, мама в семье. Любит учиться, хотя иногда ей дается это тяжело, любит бегать а еще иногда очень долго играть в шарики и ферму, но это временно. Постоянно занимается детьми, готовит, возит их на занятия. Очень много убирается, потому что дети постоянно мусорят. Любит кататься на велосипеде. Катается на горных лыжах. Любит сериал Stranger Things и ждет его выхода.'
            },
            {
                name: 'Женя (папа)',
                description: '37 лет, папа в семье, очень много работает, работает менеджером продукта в Майкрософт, бегает и иногда занимается спортом. Любит покупать дорогую одежду и гаджеты. Любит кататься на велосипеде. Катается на сноуборде. Любит сериал Stranger Things и ждет его выхода.'
            }
        ];
